...
class InitState extends FlxUIState {
  ...
  public static var isAmd:Bool;  
  public static function getGraphicsVendor():String {
    var gl = GL.context;
  ...
  override function create()
  {
    ...
    currentOptions.showRatings = false;
    currentOptions.showComboCounter = false;
    currentOptions.holdsBehindReceptors = true;
    currentOptions.useEpic = false;
    currentOptions.useNotesplashes = false;
    currentOptions.showCounters = false;
    currentOptions.camFollowsAnims = true;
    var vendor = getGraphicsVendor();
    trace(vendor);
   
    isAmd = vendor.indexOf("ATI") >= 0 || vendor.indexOf("AMD") >= 0;
    ...
    PlayerSettings.init();
		...
		FlxG.save.bind('hotsave', 'HMNTEAM');
		Highscore.load();
