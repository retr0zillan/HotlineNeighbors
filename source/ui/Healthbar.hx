...
class Healthbar extends FlxSpriteGroup {
  ...
  public function new(x:Float,y:Float,player1:String,player2:String,?instance:FlxBasic,?property:String,min:Float=0,max:Float=2,baseColor:FlxColor=0xFFFF0000,secondaryColor:FlxColor=0xFF66FF33){
    ...
    iconP1.setPosition(1142, 367);


    iconP2 = new HealthIcon(player2, false);
    iconP2.setPosition(-13, 367);

  

    holder = new FlxSprite(-95,300);
    holder.loadGraphic(Paths.image('IconHolder', 'preload'));
    holder.scale.set(0.4,0.4);
    holder.antialiasing=true;
  
    holder2 = new FlxSprite(1070,300);
    holder2.loadGraphic(Paths.image('IconHolder', 'preload'));
    holder2.flipX=true;
    holder2.scale.set(0.4,0.4);
    holder2.antialiasing=true;
